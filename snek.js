...
function init_snek(current_snek){
    ...
    // sq_array[current_snek[0][2]][current_snek[0][3]] += 4;
    // sq_array[current_snek[1][2]][current_snek[1][3]] += 4;
    return sq_array;
}
...
function move_snek(){
    ...
    else if(sq_array[current_snek[0][2]][current_snek[0][3]] == 2 ||
        sq_array[current_snek[0][2]][current_snek[0][3]] == 3) {
        sq_array[current_snek[0][2]][current_snek[0][3]] -= 2;
        [x, y] = random_apple();
        sq_array[x][y] += 2;
    }
    else{
